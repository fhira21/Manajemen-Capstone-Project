...
import { addCVMahasiswa, getCVMahasiswa } from "../../data/localStorage";
...
export default function AddCurriculumVitae() {
    ...
    const handleSubmit = (e) => {
        ...
        if (isValid) {
            ...
            const cvData = {
                ID_CV: generateCVId(),
                ID_User: user?.id || user?.ID_User || '', // Use current user's ID
                Nama: formData.nama,
                Tanggal_Lahir: formData.tanggal_lahir,
                Gender: formData.gender,
                Email: formData.email,
                Telepon: formData.telepon,
                Email_Aktif: formData.email_aktif,
                Alamat: formData.alamat,
                Ringkasan: formData.ringkasan,
                Link_Penghubung: formData.link_penghubung,
                ...
                Bidang: Array.isArray(formData.bidang) ? formData.bidang.join(', ') : formData.bidang,
                Keterampilan: Array.isArray(formData.keterampilan) ? formData.keterampilan.join(', ') : formData.keterampilan
            };
